      ...
      <div className="flex flex-wrap lg:flex-nowrap justify-center">
        ...
        <div className="flex m-3 flex-wrap justify-center gap-1 items-center">
          {earningData.map((item) => (
            <div
              key={item.title}
              className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg p-4 w-56 pt-9 rounded-2xl flex justify-center flex-col text-center"
            >
              <button
                type="button"
                style={{ color: item.iconColor, backgroundColor: item.iconBg }}
                className="text-2xl opacity-0.9 rounded-full p-4 hover:drop-shadow-xl flex justify-center"
              >
                {item.icon}
              </button>
              <p className="mt-3">
        ...
        <div className="bg-white dark:text-gray-200 dark:bg-secondary-dark-bg m-3 p-4 rounded-2xl md:w-780">
            ...
            <div className="mt-10 flex gap-10 flex-wrap justify-center">
              <div className="border-r-1 border-color m-4 pr-10">
                ...
                <div>
                  <p>
                    <span className="text-3xl font-semibold">$48,327</span>
                  </p>
                  <p className="text-gray-500 mt-1">
                    Expense
                  </p>
